...
<section data-iaw-opening="true" style="margin:4px 16px 38px;padding:44px 0 22px;text-align:center;box-sizing:border-box;">
  <div style="display:inline-block;position:relative;width:100%;max-width:430px;padding:20px 0 16px;text-align:left;box-sizing:border-box;border-top:1px solid rgba(8,22,241,0.22);border-bottom:1px solid rgba(8,22,241,0.22);overflow:hidden;">
    ...
    <p style="position:relative;margin:0 0 12px;padding:0;color:#8f8f8f;font-size:10px;line-height:1;font-weight:800;letter-spacing:0.18em;text-transform:uppercase;">Information Aesthetician / Weekly</p>
    <p style="position:relative;margin:0;padding:0;color:#111;font-size:20px;line-height:1.45;font-weight:800;letter-spacing:0;text-align:left;">
      点击上方卡片，发现更多产品
    </p>
...
<section data-iaw-ending="true" style="margin:58px 16px 0;padding:52px 0 34px;text-align:center;box-sizing:border-box;">
  <div style="display:inline-block;width:100%;max-width:430px;text-align:left;box-sizing:border-box;">
    ...
    <div style="border-top:1px solid rgba(0,0,0,0.12);padding-top:18px;">
      <p style="margin:0 0 10px;padding:0;color:#333;font-size:14px;line-height:1.55;font-weight:500;letter-spacing:0;text-align:left;">
        <span style="display:inline-block;min-width:76px;color:#8a8a8a;font-size:10px;font-weight:800;letter-spacing:0.14em;text-transform:uppercase;vertical-align:baseline;">Layout</span>
        内容排版 / 周一同学Zelina
      </p>
      <p style="margin:0;padding:0;color:#333;font-size:14px;line-height:1.55;font-weight:500;letter-spacing:0;text-align:left;">
        <span style="display:inline-block;min-width:76px;color:#8a8a8a;font-size:10px;font-weight:800;letter-spacing:0.14em;text-transform:uppercase;vertical-align:baseline;">Planning</span>
        内容策划 / 周一同学Zelina
      </p>
    </div>
  </div>
